...
<body>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-sm-8 col-md-6">
                        <div class="info">
                            <div class="info-item">
                                <i class="fa fa-phone"></i> 01011008595
                            </div>
                            <div class="info-item">
                                <i class="fa fa-envelope-o"></i> <a href="mailto:hagarhay@gmail.com"
                ...
                <nav id="navbar-example" class="navbar navbar-expand-lg">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavDropdown">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="client.php">CLEINT</a>
                            </li>
    ...
    <div class="section banner-page" data-background="public/images/drivers.jpg">
        <div class="content-wrap pos-relative">
            <div class="d-flex justify-content-center bd-highlight mb-3">
                <div class="title-page">Drivers</div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="login-content">
            <form action="logindriver.php" method="POST" name="myform">
