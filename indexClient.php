    ...
    <div class="container">
        ...
        <div class="page-header">
            <h1>
               ...
               echo 'Welcom'.' '.$_SESSION['user_client']['name'];
        ...
        <table class='table table-hover table-responsive table-bordered'>
            ...
            <tr>
                ...
                <td>
                    <a href='deleteClient.php?id=<?php echo $raw['id']; ?>' class='btn btn-danger m-r-1em'>Delete</a>
                    <a href='editClient.php?id=<?php echo $raw['id']; ?>' class='btn btn-primary m-r-1em'>Edit</a>
